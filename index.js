...
class Account {
    ...
    pin;
    activeStatus;
    constructor(accountNumber, accountHolder, creditCardNumber) {
...
async function loginAccount() {
    ...
    await new Promise(resolve => setTimeout(resolve, 2000));
    let check = bank.findAccount(answer.accountNum);
    if (check) {
        console.log(chalk.italic.greenBright("Account found!"));
        let findIndex = bank.accounts.indexOf(check);
...
async function showLoginMenu(index) {
